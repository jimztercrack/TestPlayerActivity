package cr.go.sinart.testplayeractivity.controller;
...
import cr.go.sinart.testplayeractivity.R;
import cr.go.sinart.testplayeractivity.player.DemoPlayer;
import cr.go.sinart.testplayeractivity.player.ExtractorRendererBuilder;
